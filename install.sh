        ...
        for (let call of node) {
            if (call.status === 'offer') {
                ...
                try {
                    ...
                    const pesan = `⚠️ *SISTEM OTOMATIS*\n\nMaaf, nomor ini dikelola oleh Bot dan tidak dapat menerima panggilan telepon/video.\n\nSilakan kirimkan pesan melalui chat/teks saja. Admin akan merespon secepatnya Terima kasih. 🙏`;
